// Generated on 2018-04-08 using generator-angular 0.9.8
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      development: {
        files: {
          'app/src/styles/style.css': 'app/src/styles/style.less'
        }
      }
    },
    ...
    usemin: {
      ...
      css: ['<%= yeoman.dist %>/src/styles/{,*/}*.css'],
      options: {
        assetsDirs: ['<%= yeoman.dist %>','<%= yeoman.dist %>/src/images']
      }
    },
